...
import CardTopAiring from "./cardAiring";

export default function AiringPopular(props) {
   ...
   return (
      <div className="w-full  border-t-2 border-rose-900 flex flex-col items-center">
         <div className="">
            ...
            <div
               className={`grid place-content-center place-items-center py-3 ${
                  props.viewMode ? "singleModes" : "doubleModes"
               }`}
            >
               <CardTopAiring loadMore={more} viewMode={props.viewMode} />
            </div>
